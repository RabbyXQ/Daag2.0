    ...
    try {
      const response = await fetch(`http://localhost:3000/api/land/${id}`, {
        ...
        headers: {
          ...
          'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsImlhdCI6MTczMjg0ODYyOCwiZXhwIjoxNzMyODUyMjI4fQ.Gxn6zVcGm0eH4bUiBIBQRGdyXDVWInYItHdbhuLG-AE', // Your token here
        },
